      ...
      <div className="p-8 bg-gray-50 min-h-screen">
        <div className="flex flex-col justify-between items-center mb-8 gap-4">
          ...
          <button
            ...
            className="flex items-center space-x-2 px-5 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all shadow-md hover:shadow-lg whitespace-nowrap"
          >
            <FaPlus />
            <span>Add User</span>
          </button>
